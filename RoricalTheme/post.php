                            ...
                            <div class="card-profile-actions card-profile-stats d-flex justify-content-center">
                                <?php if (count($this->tags) > 0): ?>
                                    <?php foreach ($this->tags as $tag): ?>
                                        <a href="<?php echo themeTransfer($tag['permalink'], 'URL'); ?>" class="btn btn-sm btn-info mr-4"><?php echo themeTransfer($tag['name'], 'HTML'); ?></a>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <a class="btn btn-sm btn-info mr-4">无标签..</a>
                                <?php endif; ?>
                                <?php foreach ($this->categories as $category): ?>
                                    <a href="<?php echo themeTransfer($category['permalink'], 'URL'); ?>" class="btn btn-sm btn-default float-right"><?php echo themeTransfer($category['name'], 'HTML'); ?></a>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    </div>
